...
[`@aws-sdk/client-repostspace`](https://www.npmjs.com/package/@aws-sdk/client-repostspace/v/3.1075.0).
...
- @aws-sdk/client-repostspace v3.1075.0 - [https://cloud-sdk-builds.github.io/?sdk=client-repostspace&version=3.1075.0](https://cloud-sdk-builds.github.io/?sdk=client-repostspace&version=3.1075.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-repostspace@3.1075.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MEeYgBRKIC+1+rSDJY0gqEO7rDIT5BLbImi+yxrx7yFlvovnrWMGqhUuERvDrFeG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-repostspace": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-repostspace@3.1075.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-repostspace@3.1075.0/index.min.mjs": "sha384-MEeYgBRKIC+1+rSDJY0gqEO7rDIT5BLbImi+yxrx7yFlvovnrWMGqhUuERvDrFeG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-repostspace/blob/refs/tags/3.1075.0/LICENSE
```
